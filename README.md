...
- **Toolbar** — a Gerber-style ribbon: **Cut Plan / Marker** workspace toggle, then **File · Piece · Marker · Fabric · Advanced · View** tabs mirroring the classic Easy Marking layout (Advanced is reserved for split piece / placement templates / cut sequencing). New Order, Save, undo/redo, Auto-Nest and Help stay always visible. Zoom is canvas-anchored.
  - **File** — open / plot SVG / PNG. **Piece** — rotate, flip, butt-slide, **fit piece** (one-piece auto-place), **duplicate placed**, return / **unplace small** / return all. **Marker** — effort + compact, **flip marker X / Y / XY**, **measure tools** (point↔point, piece↔piece closest gap, piece↔edges), **approval flags** (Needs approval / Approved, saved with the marker). **Fabric** — rotation rule + edit order. **View** — **zoom window** (W), **thumbnail minimap** (click to jump the view), **restore points** (manual snapshots + one stored automatically before every Auto-Nest).
